...
//Add Desire Routes
Route::get("/desire-view", [App\Http\Controllers\DesireController::class, 'create'])->name('Add-desire');
...
//delete Reservation
Route::delete("/reserve/{user_id}/{real_id}", [App\Http\Controllers\ReserveController::class, 'destroy'])->name('delete-reserve');
...
Route::get('send-mail', function () {
  ...
  $details = [
      'title' => 'Mail From Key In Click Team',
      'body' => 'This is for testing email using smtp'
  ];
 
  Mail::to('zenaserwan96@gmail.com')->send(new \App\Mail\AttachmentMail($details));
